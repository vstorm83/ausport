...
class AW_Autorelated_Block_Adminhtml_Blocks_Product_Edit_Tab_General extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
        ...
        /*
          if(Mage::getSingleton('adminhtml/session')->getPopupData()==NULL && Mage::registry('productblock_data')->getData()==NULL)
          $form->setValues(array('align'=>Mage::helper('awautorelated')->getDefaultPosition()));
         */
